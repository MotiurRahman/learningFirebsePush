...
!function (a, b) {
  ...
  var c = [],
    ...
    var a = d.createElement("input"),
      ...
      Za = r.expr.attrHandle;r.fn.extend({ attr: function (a, b) {
    ...
    var c = Za[b] || r.find.attr;Za[b] = function (a, b, d) {
      ...
      _a = /^(?:a|area)$/i;r.fn.extend({ prop: function (a, b) {
    ...
    return a.getAttribute && a.getAttribute("class") || "";
      ...
      var b,
        ...
        b = a.match(K) || [];while (c = this[i++]) if (e = bb(c), d = 1 === c.nodeType && " " + ab(e) + " ") {
          g = 0;while (f = b[g++]) d.indexOf(" " + f + " ") < 0 && (d += f + " ");h = ab(d), e !== h && c.setAttribute("class", h);
        }
      }return this;
      ...
      var b,
        ...
        b = a.match(K) || [];while (c = this[i++]) if (e = bb(c), d = 1 === c.nodeType && " " + ab(e) + " ") {
          g = 0;while (f = b[g++]) while (d.indexOf(" " + f + " ") > -1) d = d.replace(" " + f + " ", " ");h = ab(d), e !== h && c.setAttribute("class", h);
        }
      }return this;
      ...
      var b,
          c,
          d = 0;b = " " + a + " ";while (c = this[d++]) if (1 === c.nodeType && (" " + ab(bb(c)) + " ").indexOf(b) > -1) return !0;return !1;
    } });var cb = /\r/g;r.fn.extend({ val: function (a) {
      var b,
          c,
          d,
          e = this[0];{
  ...
  });var db = /^(?:focusinfocus|focusoutblur)$/;r.extend(r.event, { trigger: function (b, c, e, f) {
      var g,
          h,
          i,
          j,
